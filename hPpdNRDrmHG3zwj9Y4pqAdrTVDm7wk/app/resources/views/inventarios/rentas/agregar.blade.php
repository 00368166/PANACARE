...
<input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingresar CURP">
</div>
...
<textarea class="form-control" ame="descrip" id="descrip" rows="3" placeholder="Enter ..."></textarea>
</div>
</div>
